    ...
    <div className="App">
      ...
      <div className="content-wrapper">
        <div className="content">
          ...
          <br/> <br/>
          <img width="25px" src={starlink} /><span>God makes a promise to Pharaoh that his body would be preserved, despite being crushed underneath the Red Sea, split by Moses. (10:92). Today Ramses II is the only pharaoh with a passport, is well preserved, and on display in the Egyptian Museum in Cairo.</span>
          <br/> <br/>
