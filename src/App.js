    ...
    <div className="App">
      ...
      <div className="content-wrapper">
        <div className="content">
          ...
          <br/> <br/>
          <img width="25px" src={starlink} /> <span>The Quran's middle chapter is titled 'The Iron'. Correlates with the center of our Earth, which consists of only iron and nickel.</span>
          <br/> <br />
          <h3>Prophecy</h3>
