    ...
    <div className="App">
      ...
      <div className="content-wrapper">
        <div className="content">
          ...
          <br/> <br />
          <h3>Historical</h3>
          <img width="25px" src={starlink} /><span>The name 'haman' appears in the Quran as the title of Pharaoh's close advisor, priest, and manager of construction. However the Book of Esther, accepted by some Christiand and Jews, have another Haman, whose purpose is as advisor to a Persian King Xerxes. Historians have conclusively rejected the Book of Esther as a book of historical fiction. There is no recorded Haman among any Persian kings and many of the story's details are false and inaccurate. However there is such a title 'ha-amanah' which is Egyptian for High Priest of Amun. This title was the highest priesthood one could achieve in that time period of Egypt. As well as the fact one particular person, Bakenkhonsu, during Ramses II's reign, was a priest for a majority of the Pharaoh's life, by his side. This historical error of the Book of Esther is instead replaced with a historical fact, that haman is indeed properly placed in Egyptian history rather than Persian. The Quran corrects the Bible yet again. </span>
          <br/> <br/>
