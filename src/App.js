    ...
    <div className="App">
      ...
      <div className="content-wrapper">
        <div className="content">
          ...
          There were two instances of Bubonic plague. In the 1300’s and the 1800’s. Both times Mecca was affected. But as the Hadith promised, Medina has been untouched by it despite it being near Mecca.
