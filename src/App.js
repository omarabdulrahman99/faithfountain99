    ...
    <div className="App">
      ...
      <div className="content-wrapper">
        <div className="content">
          ...
          <br/> <br />
          <h3>Historical</h3>
          <img width="25px" src={starlink} /><span> The Bible's narrative on the Israelite Exodus says that the Jews numbered in 600,000. History shows no such records of this size. The Quran however tells us the Israelites in Egypt were just a 'small band' of people, which fits in with history: Quran 26:53-56: "Then Pharaoh sent among the cities gatherers, saying: "These (Israelites) are only a small band of people. And indeed they are enraging us. And we are a host, well-armed"</span>
          <br/> <br/>
      ...
      <div className="content-wrapper">
        <div className="content">
          ...
          <br/> <br />
          <img width="25px" src={starlink} /> <span>In Musnad Ahamad Hadith #18207 (2nd Entry), The Prophet said: ‘Al-Dajjal will come, and he will climb Uhud, and he will look at Al-Madinah and he will say to his companions: ‘Do you see that <b>white palace? That is the mosque of Ahmad.’</b> Then he will come to Al-Madinah, and he will find on each gateway of it drawn (armed) an angel, so he will come to the wasteland of Al-Jurf, and he will strike his camp. Then Al-Madinah will quake three times, and there will not remain a single (male) hypocrite or (female) hypocrite, and no (male) evil-doer or (female) evil-doer but they will go out to him, and that is the Day of Riddance.” The point is that the mosque of Ahmad aka Prophet Muhammad still remains with us today. Reconstructed, and in the form of a white palace when looking at it. This mosque was nowhere near it's size as we see it today, nor in any palace fashion. It was a tiny humble praying place made of wood. It wasn't until 100 years after the Prophet's death that it was upgraded. And even then, throughout history, the color of the palace changed depending on the material used to build it. Today it remains with us to be a white palace.</span>
          <br/> <br />
