    ...
    <div className="App">
      ...
      <div className="content-wrapper">
        <div className="content">
          ...
          <br/> <br />
          <img width="25px" src={starlink} /> <span>"The Romans have been defeated in the neighboring land, but after their defeat they shall gain victory in a few years. All power belongs to Allah both before and after. On that day will the believers rejoice" Quran 30:1-5. This was an insane prediction to make for someone claiming to be a Prophet. The Byzantines suffered a severe crippling series of losses by the Persians, it was nearly hopeless as the Persians took over vast Roman territory and nearly destroyed their capital. Yet they triumphed in a turning point battle in which they caught a Persian ambush 'by luck' and reversed it. Ever since they won victory after victory and brought Persia to its knees, forcing the own Persian royal family to assasinate their current king (whom by the way, was recorded to have said he wouldn't rest until Heracules, the Roman leader & general, was brought to im in chains. He suffered a humiliating defeat however instead) and place a new one that would agree to a treaty. and near that day the Muslims also triumped against the Meccan pagans.</span>
          <br/> <br/>
          ...
          <br/> <br/>
          <img width="25px" src={starlink} /> <span>Recently a 'checksum' was discovered, which verifies the Quran's preservation.  If you add the chapter number to verse number, for each chapter, and then if you take the odd chapters results and sum them, they turn out to be equal to the sum of the chapter numbers of the quran. If you take the even chapter results and sum them, they turn out to be equal to total number of verses in quran. Not only that, the odd results are 57 in total, and even results are 57 in total....Just incredible symmetry & balance. 3 impressive signs all bundled into one. On top of that, using those very same sums, we get the golden ratio, by applying the golden ratio formula to the duplicate and non duplicate sums! The Quran makes a specific mention of even and odd, the Creator swears by them Quran 89:3, along with two other things "And by the even and the odd" and three verses later asks us, Quran 89:6  "Is there in that an oath for a sensible person?". It's only been a recent discovery, nobody made a mention of this math structure until the late 1900's. Remember that the Quran was revealed as a speech, usually directly on the spot of a situation which needed divine revelation, it was never revealed as an entire book, only in pieces, and not even in chronological order. It is impossible for anybody to multiply, sum, calculate especially as a 7th century Arab the amount of verses to make this all fit. It is only divinely planned. https://www.youtube.com/watch?v=OOfe-lWMwtg&ab_channel=StraightPath, https://aqtthq.blogspot.com/2018/09/golden-ratio-in-quran.html  and  https://youtu.be/4Ha5YoPWOww</span>
          <br/> <br/>
          ...
          <br/> <br />
          <h3>Historical</h3>
          <img width="25px" src={starlink} /><span>The name 'haman' appears in the Quran as the title of Pharaoh's close advisor, and in charge of construction. However the Book of Esther, accepted by some Christians and Jews, have another Haman, whose purpose is as advisor to a Persian King Xerxes. Historians have conclusively rejected the Book of Esther as a book of historical fiction. There is no recorded Haman among any Persian kings and many of the story's details are false and inaccurate. However there is such a title 'ham-amana' which is Egyptian for High Priest of Amun. This title was the highest priesthood one could achieve in that time period of Egypt. The Priest of Amun held enormous power, second to the Pharaoh. In fact they eventually gained more power than the Pharaoh later on in history. As well as the fact one particular person, Bakenkhonsu, during Ramses II's reign, was a priest for a majority of the Pharaoh's life, by his side, only dying 1-3 years before him. The Quran does not mention that he drowned with Pharaoh, there are two instances in which the Quran says 'Pharaoh and Haman and their armies' but when referring to the drowning, only 'Pharaoh and his army' is mentioned, with no Haman, which does fit in with this timeline of Bakenkhonsu dying before Pharaoh (Ramses II). This historical error of the Book of Esther is instead replaced with a historical fact, that haman is indeed properly placed in Egyptian history rather than Persian. The Quran corrects the Bible. </span>
          <br/> <br/>
          <img width="25px" src={starlink} /><span>God makes a promise to Pharaoh that his body would be preserved, despite being crushed underneath the Red Sea, split by Moses. (10:92). Today Ramses II is the only pharaoh with a passport, is well preserved, and on display in the Egyptian Museum in Cairo. This promise to preserve his body is found in no other scripture. It is a lesson to show us even the greatest of people in power and ego are powerless. On display with their deceased corpse as powerless.</span>
          <br/> <br/>
          <img width="25px" src={starlink} /><span> The Bible's narrative on the Israelite Exodus says that the Jewish men numbered in 603,550, which means millions if counting women and children. History shows no such records of this size. The Quran however tells us the Israelites in Egypt were just a 'small band' of people, which fits in with history: Quran 26:53-56: "Then Pharaoh sent among the cities gatherers, saying: "These (Israelites) are only a small band of people. And indeed they are enraging us. And we are a host, well-armed". Historians have suggested the exodus could have been a much smaller group.</span>
          <br/> <br/>
      ...
      <div className="content-wrapper">
        <div className="content">
          ...
          <h3>Psychology</h3>
          <img width="25px" src={starlink} /> <span> Despite some critics believing the Prophet was epileptic, imagine being epileptic, receiving revelation spontaneously in which the Prophet described was so heavy at times he felt as if he would die, or as if his leg would break, aka causing him to freeze and lose focus on reality, and participating in at least 29 battles on the front lines over 23 years! And winning nearly all of them without any major injuries! And surviving them and still leading the Islamic empire. Would an 'epileptic' person survive such an enormous amount of fighting, unless it is God's help? </span>
          <br/> <br/>
          <img width="25px" src={starlink} /> <span>The Prophet continued to live a life of poverty even after ruling most of Arabia. One of his close companions weeped at the sight. "Apostle of Allah, why should I not shed tears? This mat has left its marks on your sides and I do not see in your store room (except these few things) that I have seen; Ceasar and Closroes are leading their lives in plenty whereas you are Allah's Messenger. His chosen one, and that is your store! He said: Ibn Khattab, aren't you satisfied that for us (there should be the prosperity) of the Hereafter, and for them (there should be the prosperity of) this world? I said: Yes." https://sunnah.com/muslim:1479</span>
          ...
          <br/><br/>
          <h3>Prophecy</h3>
          <img width="25px" src={starlink} /> <span> A prophecy that Medina would never be affected by plague, or have the Dajjal enter it. The Kaaba has never had idols in it ever since the Prophet. And that the same spot Abraham built it has been under Muslim control for the last 1400 years. Neither Mecca nor Medina have been conquered by foreign nonMuslim nations ever since the Prophet.
          There were two instances of Bubonic plague. In the 1300’s and the 1800’s. Both times Mecca was affected. But as the Hadith promised, Medina has been untouched by it despite it being near Mecca. While also having small towns and villages around Medina infected, Medina was still untouched.
          Source Hadiths: https://sunnah.com/search?q=Dajjal+plague  Source Medina/Mecca history & plagues: https://www.jstor.org/stable/3632188 Page 287 of “Taun and Waba Conceptions of Plague and Pestilence in Early Islam” by Lawrence I. Conrad</span>
          <br/><br/>
          <img width="25px" src={starlink} /> <span>"The Last Hour will not come before wealth becomes abundant and overflowing, so much so that a man takes Zakat out of his property and cannot find anyone to accept it from him and till the land of Arabia reverts to meadows and rivers." This prophecy is almost insane to make. Nowhere in Arab tradition did anybody believe that Arabia used to be forests with rivers. RIVERS! FORESTS! And that it would return to transforming into rivers and forests sometime before the day of judgment! It was only recently discovered that Arabia changes climate every 23,000 years. Even the Sahara used to be a jungle. Perhaps with climate change, people will be forced to turn deserts into green land to combat global warming. Something initiated by Allan Savory already. However even if this method is unlikely to change much. Research was done on what would happen if the Earth reversed its rotation. This is relevant because of another prophecy that the Sun would rise from the West one day. Indicating a rotation of the Earth shifting. The results show: 'Deserts would cover North America, arid sand dunes would replace expanses of the Amazon rainforest in South America, and lush, green landscapes would flourish from central Africa to the Middle East.' So this will certainly cause a rapid change in climate. Also just consider how insane it is to make such a prophecy anyways when all your people and yourself have known your lands to be nearly almost deserts. To have been meadows in the past and to return to such later on? Highly insane! Source: https://www.livescience.com/62405-what-if-earth-rotation-reversed.html</span>
          <br/><br/>
